...
public class ClazzController {
    ...
    //删除单个和多个班级
    @Operation(summary = "删除班级", description = "删除单个和多个班级", parameters = @Parameter(name = "ids", description = "要删除的多个班级的ID的JSON数组", required = true))
    ...
    //增加或者修改班级信息
    @Operation(summary = "增加或者修改班级", description = "增加或者修改班级信息", parameters = @Parameter(name = "clazz", description = "JSON格式的班级信息", required = true))
